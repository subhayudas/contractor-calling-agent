...
-- This will drop the old table and create the new electrical contractor schema

-- Drop the old table (this is safe - it recreates it immediately after)
DROP TABLE IF EXISTS public.leads CASCADE;
DROP VIEW IF EXISTS public.leads_stats CASCADE;

-- Create NEW leads table for electrical contractor services
...
-- Success message
SELECT 'Database updated successfully! Your electrical contractor table is ready.' as status;
