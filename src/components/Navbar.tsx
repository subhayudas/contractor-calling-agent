      ...
      <div className="max-w-screen-xl mx-auto">
        ...
        >
          ...
          <div className="flex md:hidden">
            <button
              onClick={toggleMenu}
              className="text-primary p-2.5 focus:outline-none focus:ring-2 focus:ring-primary/50 rounded-lg transition-transform active:scale-95"
          ...
          <div className="hidden md:flex md:items-center md:space-x-6">
            ...
            <div className="relative">
              <button
                ...
                className="flex items-center space-x-2 text-foreground hover:text-primary transition-colors duration-300 px-4 py-2 rounded-lg hover:bg-primary/10 group"
              >
                <span className="font-medium tracking-wide">Navigate</span>
                <ChevronDown 
                    ...
                    {navigationItems.map((item) => {
                      ...
                      return (
                        <button
                          ...
                          className="w-full text-left px-4 py-2.5 text-foreground hover:text-primary hover:bg-primary/10 transition-all duration-200 flex items-center group"
                        >
                          <Icon className="h-4 w-4 mr-3 group-hover:scale-110 transition-transform text-primary" />
            ...
            <div className="flex items-center space-x-5">
              <a
                ...
                className="text-foreground/60 hover:text-primary transition-all duration-300 transform hover:scale-110 hover:-translate-y-1"
              >
                <svg
        ...
        <div className="fixed top-[calc(4rem)] left-3 right-3 glass-card rounded-xl shadow-xl p-4 z-50 max-h-[calc(100vh-5rem)] overflow-y-auto animate-in fade-in slide-in-from-top-2 duration-200 md:hidden">
          <div className="flex flex-col space-y-5">
            ...
            <div className="space-y-1">
              <h3 className="text-foreground font-medium text-sm uppercase tracking-wider px-3 py-2 text-center">
                Navigate
              </h3>
                ...
                {navigationItems.map((item) => {
                  ...
                  return (
                    <button
                      key={item.name}
                      onClick={() => handleSmoothScroll(item.href)}
                      className="text-foreground hover:text-primary px-3 py-2 rounded-lg text-sm font-medium transition-colors duration-200 hover:bg-primary/10 text-left flex items-center"
                    >
            ...
            <div className="flex justify-center space-x-6 py-3 border-t border-primary/10">
              <a
                href="https://twitter.com"
                target="_blank"
                rel="noopener noreferrer"
